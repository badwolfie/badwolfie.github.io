...
\par{\centering{\Huge Ian Y. \textsc{Hern\'andez S\'anchez}}\bigskip\par} % Your name

\section{Datos Personales}

\begin{tabular}{rl}
\textsc{Lugar de nacimiento:} & Acapulco, Gro. \\
\textsc{Fecha de nacimiento:} & 29 Octubre 1993 \\
\textsc{C.U.R.P.:} & HESI931029HGRRNN07 \\
\textsc{Direcci\'on:} & Calle 15 278, Torre 2 - Depto. 301, Guadalupe Proletaria \\
 & Gustavo A. Madero, D.F. \\ 
 & C.P. 07670 \\
\textsc{Telef\'ono:} & 55 45 90 33 88\\
\textsc{email:} & \href{mailto:ianyo27@gmail.com}{ianyo27@gmail.com}
\end{tabular}
